...
const DOWNLOAD_URL = 'https://github.com/ShaharHarel21/ezLander/releases/download/v1.16.0/EzLander-v1.16.0.zip'
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <a
                  href={DOWNLOAD_URL}
                  download
                  className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-xl font-semibold text-lg hover:opacity-90 transition-opacity"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
